---
title: 存档-适用于 Windows 10 的 Intune MDM 安全基线设置的
titleSuffix: Microsoft Intune
description: 过去的用于管理 Windows 10 使用 Microsoft Intune 的 MDM 安全基线设置的发布版本的存档
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 06/27/2019
...
ms.locfileid: "67418954"
---
<!-- This article contains the exact baseline details for baseline versions that were previously published in security-baseline-settings-mdm.md.  -->

# <a name="archive-of-mdm-security-baseline-settings"></a>MDM 安全基准设置的存档  

查看已存档版本的 Intune MDM 安全基线的详细信息。  

当发布新的 MDM 安全基线后时，前面的设置列表从移动安全基线设置文章到该存档文件。 这些版本仍支持使用，而此存档提供用于帮助了解较旧的基线版本的默认设置。

如果基线版本不再受支持的使用，它将然后从这篇文章。

- 查看设置，它们位于[当前 MDM 安全基准](security-baseline-settings-mdm.md) 
- 了解如何[安全基准](security-baselines.md)，以及如何升级安全基线配置文件中的基线版本。

## <a name="preview-mdm-security-baseline-for-october-2018"></a>预览版：2018 年 10 月的 MDM 安全基线  

*被取代此基线[MDM 安全基线的 Spring 2019 （19 小时 1）](security-baseline-settings-mdm.md)*
...
[查看当前的基线版本](security-baseline-settings-mdm.md)  
[升级配置文件中使用的新基线版本](security-baselines.md#change-the-baseline-instance-for-a-profile)