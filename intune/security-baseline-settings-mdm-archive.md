---
title: 适用于 Windows 10 的 Intune MDM 安全基准设置存档
titleSuffix: Microsoft Intune
description: 存档过去版本的 MDM 安全基线设置, 以便通过 Microsoft Intune 来管理 Windows 10
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 06/27/2019
...
ms.locfileid: "67735784"
---
<!-- This article contains the exact baseline details for baseline versions that were previously published in security-baseline-settings-mdm.md.  -->

# <a name="archive-of-mdm-security-baseline-settings"></a>存档 MDM 安全基线设置  

查看 Intune 的 MDM 安全基线存档版本的详细信息。  

新的 MDM 安全基线发布时, 以前的设置列表将从 "安全基线设置" 文章移到此存档。 仍支持使用这些版本, 提供此存档以帮助了解旧基线版本的默认设置。

如果不再支持使用基准版本, 则会将其从本文中删除。

- 查看[当前 MDM 安全基线](security-baseline-settings-mdm.md)中可用的设置 
...
[查看当前基线版本](security-baseline-settings-mdm.md)  
[使用新基线版本升级配置文件](security-baselines.md#change-the-baseline-instance-for-a-profile)