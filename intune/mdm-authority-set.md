...
7. 将 MDM 机构更改为 Configuration Manager 后，可设置 [iOS 注册](https://docs.microsoft.com/en-us/sccm/mdm/deploy-use/enroll-hybrid-ios-mac)和 [Android 注册](https://docs.microsoft.com/en-us/sccm/mdm/deploy-use/enroll-hybrid-android)。
