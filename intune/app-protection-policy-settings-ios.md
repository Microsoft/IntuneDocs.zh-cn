...
| **阻止“另存为”** | 选择“是”，在此应用中禁用“另存为”选项。 如果你希望允许使用“另存为”，请选择“否”。 **注意：** Microsoft Excel、OneNote、Outlook、PowerPoint 和 Word 支持此设置。 它也可能受第三方和 LOB 应用支持。 <p>**选择可保存公司数据的存储服务** <br>用户可以保存到所选的服务（OneDrive for Busines、SharePoint 和本地存储）中。 将阻止所有其他服务。</p> | 否<p>&nbsp;</p><p>&nbsp;</p>未选择任何项 |
