...
> [!NOTE]  
> 在 2019 年 6 月预览 MDM 安全基线已被取代的版本*MDM Spring 2019 更新 （19 小时 1） 的安全基线*模板，为 generaly 可用 （未处于预览状态）。 提供之前创建的配置文件*MDM Spring 2019 更新 （19 小时 1） 的安全基线*基线不会更新以反映的设置和 Spring 2019 更新 （MDM 安全基线中的值19 H 1) 版本。  尽管不能创建新的配置文件基于预览版模板，但可以编辑并继续使用以前创建的基于预览版模板的配置文件。   
