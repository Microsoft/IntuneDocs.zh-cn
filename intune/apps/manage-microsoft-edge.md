...
## <a name="disable-microsoft-edge-prompt-to-save-passwords"></a>禁用 Microsoft Edge 关于保存密码的提示
...
|    Key    |    值    |
|-----------|-------------|
|     'com.microsoft.intune.mam.managedbrowser.disableFeatures'    |    “密码”将禁用“保存密码”提示。    |
