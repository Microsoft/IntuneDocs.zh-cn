...
1. 在“添加应用”窗格中，选择“应用包文件”以选择一个文件   。 随即显示“应用包文件”窗格。
    ...
    ![应用包文件窗格的屏幕截图](./media/apps-win32-app-management/apps-win32-app-02.png)
...
3. 单击“添加”以显示“添加要求规则”窗格，并配置其他要求规则   。 选择“要求类型”，以选择将用于确定如何验证要求的规则类型  。 要求规则可以基于文件系统信息、注册表值和 PowerShell 脚本。 
...
1. 在 Intune 中，选择“应用” > “所有应用”，查看已添加客户端应用的列表   。 
...
9. 在“编辑分配”窗格中，将“最终用户通知”设置为“显示所有 Toast 通知”    。 请注意，可以将“最终用户通知”设置为“显示所有 Toast 通知”、“显示计算机重启的 Toast 通知”或“隐藏所有 Toast 通知”     。
