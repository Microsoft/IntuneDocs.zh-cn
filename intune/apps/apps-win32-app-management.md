...
4. 选择组后，还可以设置“最终用户通知”  、“可用性”  和“安装截止时间”  。 有关详细信息，请参阅[设置 Win32 应用可用性和通知](~/apps/apps-win32-app-management.md#set-win32-app-availability-and-notifications)。
5. 如果想排除受此应用分配影响的任何用户组，请选择“模式”  列下的“包含”  。 将显示“编辑分配”  窗格。 可以将“模式”  从“包含”  设置为“排除”  。 单击“确定”  关闭“编辑分配”  窗格。
6. 完成设置应用分配后，单击“下一步”  显示“查看 + 创建”  页。
