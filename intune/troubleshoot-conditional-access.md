...
若要查看 Exchange Connector 日志，请使用[服务跟踪查看器工具](https://docs.microsoft.com/dotnet/framework/wcf/service-trace-viewer-tool-svctraceviewer-exe)。 此工具需要下载 Windows Server SDK。
