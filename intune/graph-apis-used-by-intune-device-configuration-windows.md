...
**CSP**:不图形 API 仅限**偏移量 URI**:仅图形 API
...
- [配置服务提供程序参考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference)(打开另一个文档站点)
