...
IT 管理员可以使用“帮助和支持”选项，通过 Azure 门户为 Intune 提交在线支持票证。 若要创建支持票证，必须为帐户分配以下某个 [Azure Active Directory 中的管理员角色](https://docs.microsoft.com/azure/active-directory/active-directory-assign-admin-roles-azure-portal)：
...
本新体验与 [Microsoft 365 管理中心](https://portal.office.com/AdminPortal/Home)中显示的体验类似，并取代了[之前的帮助和支持体验](#azure-help-+-and-support-experience)。 
