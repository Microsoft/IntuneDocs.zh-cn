...
Intune 管理员可以使用“帮助和支持”选项，通过 Azure 门户为 Intune 提交在线支持票证。 若要创建和管理支持事件，必须为帐户分配一个 Azure Active Directory (Azure AD) 角色，其中包含操作 microsoft.office365.supportTickets/allEntities/allTasks。 有关创建支持票证所需的 Azure AD 角色和权限的信息，请参阅 [Azure Active Directory 中的管理员角色](https://docs.microsoft.com/azure/active-directory/active-directory-assign-admin-roles-azure-portal)。 
...
新体验与 [Microsoft 365 管理中心](https://admin.microsoft.com/)中显示的体验类似，并取代了之前的帮助和支持体验。 
...
- **在 Azure 门户中执行以下操作：**
   ...
   从右上角选择“?” 图标，或从 Azure 门户的任何位置选择左侧导航窗格中的“帮助 + 支持”，打开 Azure 的“帮助 + 支持”。 为了获得最佳体验，请使用 Intune 边栏选项卡中的“帮助和支持”。  

借助新体验，可以访问“需要帮助?”视图，如设备管理仪表板中的图所示：  
...
以下信息介绍 Azure“帮助 + 支持”体验，使用左侧导航窗格“帮助 + 支持”，或使用 Azure 门户右上角的“?” 选项时，仍可从 Azure 门户中访问该体验。 自 2019 年 1 月起，无法从 Intune 边栏选项卡上发现的“帮助和支持”访问 Azure“帮助+支持”体验。  
