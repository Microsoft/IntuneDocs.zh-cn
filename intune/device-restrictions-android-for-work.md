...
- **通过蓝牙共享联系人**：选择“阻止”可阻止在 Android 设备配对时使用蓝牙从其他设备（例如汽车系统）访问工作联系人。 “未配置”则允许访问配对到 Android 设备的其他蓝牙设备上的工作联系人。
...
- **允许未知来源的安装**：选择“允许”以便用户可以打开未知来源。 此设置允许应用从未知来源进行安装。 “未配置”则防止用户打开未知来源。
...
可以将设备配置为运行一个应用或多个应用。 设备处于展台模式时，只能使用你添加的应用。
...
- **添加新用户**：选择“阻止”以防止用户添加新用户。 每个用户都在设备上拥有个人空间，用于自定义主屏幕、帐户、应用和设置。 “未配置”则允许用户将其他用户添加到设备中。
- **删除用户**：选择“阻止”以防止用户删除用户。 “未配置”则允许用户从设备中删除其他用户。
- **帐户更改**：选择“阻止”以防止用户修改帐户。 “未配置”则允许用户在设备上更新用户帐户。
