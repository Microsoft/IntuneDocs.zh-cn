...
# Intune 经典控制台中的新增内容 - 前几个月

[!INCLUDE[classic-portal](./includes/classic-portal.md)]

此页列出了之前在[新增功能页](whats-new.md)中列出的针对 Intune 经典控制台的新功能和说明。
...
#### 托管浏览器和公司门户的新图标 <!--918433, 918431, 971473-->
...
#### Android 公司门户中的登录进度指示器 <!--953374-->

用户启动或恢复应用时，Android 公司门户应用的更新会显示进度指示器。 该指示器将依次显示新的状态，从“正在连接...”开始，然后“正在登录...”，最后“正在检查安全性要求...”，完成后即允许用户访问该应用。 可以在 [Intune 应用 UI 页面中的新增内容](whats-new-app-ui.md)上查看适用于 Android 的公司门户应用的新屏幕。

<a id="block-apps-from-accessing-sharepoint-online----679339---" class="xliff"></a>
#### 阻止应用访问 SharePoint Online<!-- 679339 -->
...
#### 从适用于 iOS 的企业门户到 Outlook for iOS 的单一登录支持 <!--834012-->
...
#### 改进了适用于 iOS 的公司门户应用的状态消息传送 <!--744866-->
...
#### 改进 Windows 10 公司门户应用的应用安装状态 <!--676495-->
...
### Azure 上的 Intune 管理体验公开预览版的新增功能<!--736542-->
...
Azure 门户中的管理体验将使用已公布的新分组和定向功能；当现有租户迁移到新的分组体验时，也会将你迁移，以预览租户上的新管理体验。 在此期间，如果想要在租户迁移之前测试或查看任何新功能，请注册新的 Intune 试用帐户或查阅[新文档](whats-new.md)。
...
#### Azure 上 Intune 的 Appx 的新增功能 <!-- 1000270 -->
...
#### 改进了所有平台上跨公司门户应用的登录体验<!--User Story 1132123-->
...
#### 做好应对更改的计划：Intune 将更改 Intune 合作伙伴门户体验<!-- 1050016 -->
...
#### Android 适用的公司门户应用的最新用户体验<!--621622-->
...
#### 对 Windows 10 公司门户的脚本进行签名<!--941642-->
...
#### 改进了对身处中国的 Android 用户的支持<!--720444-->
...
#### 现已在 iOS 和 Android 上为 MAM 启用 Microsoft Teams
...
#### iOS 设备的组迁移将不需要对组或策略进行任何更新<!--898837-->
...
### 默认通过 Windows 设置管理 Windows 桌面设备<!--663050-->
...
### 将多个管理工具与适用于企业的 Windows 应用商店关联<!--926135-->
...
#### 解决 iOS 设备处于非活动状态，或管理控制台不能与其通信的问题 <!--unknown-->
...
### Azure 上新的 Intune 管理体验公开预览版<!--736542-->
