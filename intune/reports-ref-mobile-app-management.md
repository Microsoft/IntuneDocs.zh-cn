...
| StartDateInclusiveUTC |在数据仓库中创建此 MAM 应用时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
| DeletedDateUTC |IsDeleted 更改为 True 时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
| RowLastModifiedDateTimeUTC |上次在数据仓库中修改此 MAM 应用时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
...
| CreatedDate |创建此 MAM 应用实例记录的日期。 该值可以为 null。 |2016/11/23 - 凌晨 12:00:00 |
...
| StartDateInclusiveUtc |在数据仓库中创建此 MAM 应用实例时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
| DeletedDateUtc |IsDeleted 更改为 True 时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此 MAM 应用实例时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
...
| ApplicationInstanceKey |与此 MAM 应用签入关联的应用实例的键。 |1900/5/2 凌晨 12:00:00 |
| UserKey |与此 MAM 应用签入关联的用户的键。 |1900/1/12 凌晨 12:00:00 |
| ApplicationKey |已签入的 MAM 应用的键。 |1900/1/10 凌晨 12:00:00 |
| DeviceHealthKey |与此 MAM 应用签入关联的 DeviceHealth 的键。 |1900/1/2 凌晨 12:00:00 |
| PlatformKey |表示与此 MAM 应用签入关联的设备的平台。 |1900/1/1 凌晨 12:00:00 |
| EffectiveAppliedPolicyKey |表示与已签入的 MAM 应用关联的有效应用的策略。 有效应用的策略通过合并与特定应用和用户相关的所有策略生成。 |1900/5/2 凌晨 12:00:00 |
| LastCheckInDate |上次签入此 MAM 应用的日期和时间。 该值可以为 null。 |2016/11/23 - 凌晨 12:00:00 |
...
| 属性 | 说明 | 示例 |
|---------|------------|--------|
| DeviceHealthKey |数据仓库中设备及其相关运行状况的唯一标识符 - 代理键。 |1900/1/1 凌晨 12:00:00 |
| DeviceHealth |设备及其相关运行状况的的唯一标识符 - 类似于 DeviceHealthKey，但该标识符是自然键。 |1900/1/1 凌晨 12:00:00 |
| DeviceHealthName |表示设备的状态。 <br>不可用 - 此设备上没有信息。 <br>正常 - 设备未越狱。 <br>不正常 - 设备已越狱。 |不可用 正常 不正常 |
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此特定 MAM 设备运行状况时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
...
| RowCreatedDateTimeUtc |在数据仓库中创建 MAM 有效策略的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
...
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此特定 MAM 全局应用程序的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
...
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此平台时的 UTC 日期和时间。 |2016/11/23 - 凌晨 12:00:00 |
