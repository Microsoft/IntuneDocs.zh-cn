...
| IsDeleted |表明是否已更新此 MAM 应用记录。 True - MAM 应用拥有新纪录，其中含有此表中的更新的字段。 False - 此 MAM 应用的最新记录。 |True/False |
| StartDateInclusiveUTC |在数据仓库中创建此 MAM 应用的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
| DeletedDateUTC |IsDeleted 更改为 True 时的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
| RowLastModifiedDateTimeUTC |上次在数据仓库中修改此 MAM 应用的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
...
| PlatformVersion |安装此 MAM 应用的设备平台的版本 |2.2 |
...
| IsDeleted |表明是否已更新此 MAM 应用实例记录。 True - 此 MAM 应用实例拥有新纪录，其中含有此表中的更新的字段。 False - 此 MAM 应用实例的最新记录。 |True/False |
| StartDateInclusiveUtc |在数据仓库中创建此 MAM 应用实例的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
| DeletedDateUtc |IsDeleted 更改为 True 时的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此 MAM 应用实例的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
...
| 属性 | 描述 | 示例 |
|---------|------------|--------|
| DeviceHealthKey |数据仓库中设备及其相关运行状况的的唯一标识符 - 代理键 |1900/1/1 中午 12:00:00 |
| DeviceHealth |设备及其相关运行状况的的唯一标识符 - 类似于 DeviceHealthKey，但该标识符是自然键 |1900/1/1 中午 12:00:00 |
| DeviceHealthName |表示设备的状态。 不可用 - 此设备上没有信息。 正常 - 设备未越狱。 不正常 - 设备已越狱。 |不可用 正常 不正常 |
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此特定 MAM 设备运行状况的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
...
| PlatformName |平台名称 |不可用 无 Windows IOS Android |
| RowLastModifiedDateTimeUtc |上次在数据仓库中修改此平台的 UTC 日期和时间 |2016/11/23 - 中午 12:00:00 |
