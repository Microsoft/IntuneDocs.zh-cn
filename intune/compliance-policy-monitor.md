...
1. 在 [Azure 门户](https://portal.azure.com)中，使用 Intune 凭据登录。

2. 选择“所有服务”，筛选“Intune”，然后选择“Microsoft Intune”。

3. 选择“设备符合性” > 概述。 “设备符合性仪表板”随即打开。
...
在“设备符合性仪表板”中，可监视不同设备的符合性及其保护状态等更多内容。 你可以查看以下报告：
...
在“设备符合性仪表板”中，选择一个设备符合性磁贴即可向下钻取到每个设备（由设备符合性策略指定）的“符合性状态”、“用户的电子邮件别名”、“设备模型”和“位置”。
...
选择“更新”按钮时，弹出窗口将关闭，结果会根据所选的筛选条件进行更新。

##### <a name="device-details"></a>设备详细信息

选择设备，将打开“设备”并选中该设备。 这将提供有关应用于该设备的设备符合性策略设置的详细信息。

选中设备策略设置本身时，可看到来源于管理员指定的设备符合性设置的设备符合性策略名称。
