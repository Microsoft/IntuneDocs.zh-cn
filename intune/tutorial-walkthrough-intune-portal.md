...
7. 从 [Intune](https://aka.ms/intuneportal) 中，选择“条件访问”以显示有关访问策略的详细信息  。
    ...
    条件访问是指控制允许连接到电子邮件和公司资源的设备和应用的方式。 若要了解基于设备和基于应用的条件访问，并查找使用 Intune 条件访问的常见方案，请参阅[什么是条件访问？](conditional-access.md)
...
![常规新仪表板的图像。 图像左侧显示了包含所有服务的边栏，中间是主仪表板。 仪表板修改按钮排列在顶部，其他区域分布有可用于访问所有资源、快速入门教程、服务运行状况以及 Azure 市场的磁贴。](./media/azure-default-dashboard.png)
