...
-   详细了解[如何通过 Intune 配置 MAM 提供程序](https://docs.microsoft.com/app-protection-policies-configure-windows-10.md)。
...
设置组织中的 Intune 后，可以通过 [Azure 门户](https://docs.microsoft.com/intune-classic/deploy-use/azure-portal-for-microsoft-intune-mam-policies)创建特定于 WIP 的策略。
