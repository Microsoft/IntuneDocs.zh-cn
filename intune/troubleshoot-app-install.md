...
本部分介绍设备管理员（DA）和 Samsung Knox 注册。 有关详细信息，请参阅[android 设备管理员注册](android-enroll-device-administrator.md)和[使用 Samsung 的 Knox Mobile 注册自动注册 Android 设备](android-samsung-knox-mobile-enroll.md)。 
