...
3. 输入以下设置：
    ...
    - **名称**：输入配置文件的描述性名称。 为配置文件命名，以便稍后可以轻松地识别它们。 例如，一个好的配置文件名称是**Android 企业自定义配置文件**。
...
3. 输入以下设置：
    ...
    - **名称**：输入配置文件的描述性名称。 为配置文件命名，以便稍后可以轻松地识别它们。 例如，输入**android ent 块复制粘贴自定义配置文件**。
    - **描述**：输入配置文件的说明。 此设置是可选的，但建议进行。
    - **平台**：选择“Android Enterprise”  。
    - **配置文件类型**：选择 "**自定义**"。
