...
* 注册应用的应用程序 ID。 可在 [Azure 门户](https://portal.azure.com/)中“所有应用程序”下的“应用程序 ID”列找到此内容。 在 Azure 门户中：
