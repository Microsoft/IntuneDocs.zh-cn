...
若要配置 Windows Defender 防病毒软件，请参阅 [Windows 10 设备限制](device-restrictions-windows-10.md#microsoft-defender-antivirus)。  
...
- **网络保护**  
  **默认值**：未配置  
  ...
  - **未配置** - 禁用此功能。 不会阻止用户和应用连接到危险域。 管理员无法在 Windows Defender 安全中心中看到此活动。  
...
- **篡改保护**  
  **默认值**：未配置
  ...
  启用或禁用设备上的防篡改保护。 若要使用防篡改保护，你必须将[Microsoft Defender 高级威胁防护与 Intune 集成](advanced-threat-protection.md)，并[企业移动性 + 安全性 E5 许可证](licenses.md)。  
  - **未配置**-不会对设备设置进行任何更改。
