...
description: "了解如何创建 iOS 设备符合性策略。"
keywords: 
author: andredm7
ms.author: andredm
manager: dougeby
...
为每个平台创建符合性策略。  可以在 Azure 门户中创建符合性策略。 若要详细了解什么是符合性策略，请参阅[什么是设备符合性](device-compliance.md)主题。 若要了解创建合规性策略之前需要解决的先决条件，请参阅[设备合规性入门](device-compliance-get-started.md)主题。
