...
Windows 10 更新通道支持[作用域标记](scope-tags.md)。 可以结合使用作用域标记和更新通道，来帮助筛选和管理你所使用的配置集合。
...
- Windows 更新支持以下 Windows 10 版本：
  ...
  - Windows Holographic for Business  
    ...
    有关详细信息，请参阅[管理 Windows Holographic](windows-holographic-for-business.md)  
  
  不支持运行 Windows 10 移动版的设备。

- 在 Windows 设备上，“反馈和诊断” > “诊断和使用情况数据”必须设置为“基本”、“增强”或“完整”。  

  可以手动配置此设置，也可以使用适用于 Windows 10 及更高版本的 Intune 设备限制配置文件。 若要使用设备限制配置文件，请将“常规” > “诊断数据提交”设置至少配置为“基本”。 有关设备配置文件的详细信息，请参阅[配置设备限制设置](device-restrictions-configure.md)。  
...
Intune 管理员可以使用“卸载”来卸载（回滚）活动更新通道或暂停的更新通道的最新功能更新或最新质量更新。 卸载一种类型后，还可以卸载其他类型。 Intune 不支持也不管理用户卸载更新的功能。  
