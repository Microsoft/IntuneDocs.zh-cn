---
title: "适用于运行 macOS 的设备的 Microsoft Intune Wi-Fi 设置"
titleSuffix: 
description: "了解哪些 Intune 设置可用于在运行 macOS 的设备上配置 Wi-Fi 连接。"
keywords: 
author: vhorne
ms.author: victorh
manager: dougeby
...
本文介绍可在 Microsoft Intune 中为运行 macOS 的设备配置的 Wi-Fi 设置。
