                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure 门户中的 Intune</h3>
                                            <p>Azure 门户中的 Microsoft Intune 可用。 了解如何在新门户中管理设备和应用。 </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune 入门</h3>
                                            <p>了解基础知识： 创建组和用户。 注册设备。 分配策略和应用。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>在 Azure 中我的 Intune 功能处于哪个位置？</h3>
                                            <p>如果熟悉经典控制台中的 Intune，此文章有助于发现 Azure 上 Intune 中的功能。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/what-is-intune">所有 Intune 文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/what-is-intune">所有介绍性文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune-classic/plan-design/introduction">所有计划部署文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/device-enrollment">所有操作方法文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">所有疑难解答文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>查找所有的文档？ 请参阅<a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">所有 Intune 文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
