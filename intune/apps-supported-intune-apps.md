...
> [!NOTE]
> 对于客户端业务线应用，可使用 [Intune 应用软件开发工具包](app-sdk.md) (SDK) 或 [iOS 应用包装工具](app-wrapper-prepare-ios.md)和 [Android 应用包装工具](app-wrapper-prepare-android.md)纳入移动应用管理。 
