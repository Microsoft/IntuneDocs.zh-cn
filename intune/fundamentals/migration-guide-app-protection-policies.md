...
1. [创建应用保护策略](../apps/app-protection-policies.md#create-an-app-protection-policy)
2. [部署策略](../apps/app-protection-policies.md#deploy-a-policy-to-users)
