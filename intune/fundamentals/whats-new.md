...
<!-- ########################## -->
## <a name="week-of-february-03-2020"></a>2020 年 2 月 3 日当周

<!-- vvvvvvvvvvvvvvvvvvvvvv -->
### <a name="app-management"></a>应用管理

#### <a name="company-portal-app-improved-performance---6178652---"></a>公司门户应用提高了性能<!-- 6178652 -->
公司门户应用已更新，以支持使用 ARM64 处理器的设备（例如 Surface Pro X）的更高性能。以前，公司门户以仿真 ARM32 模式运行。 现在，公司门户应用已针对 ARM64 进行了本地编译。 有关公司门户应用的详细信息，请参阅[如何配置 Microsoft Intune 公司门户应用](~/apps/company-portal-app.md)。
...
#### <a name="new-setting-to-remove-specific-windows-built-in-apps---6184390---"></a>用于删除特定 Windows 内置应用的新设置<!-- 6184390 -->
使用新的 Windows 10 设备配置策略设置，可以删除以下 Windows 内置应用：
...
在 Microsoft 终结点管理器管理中心中，选择“设备”   > “配置文件”   > “创建配置文件”  。 然后，在“平台”中，选择“Windows 10 及更高版本”   。 在“配置文件类型”中，选择“设备限制”   。 在“设备限制”  窗格中，选择“App Store”  。 在窗格底部的“删除内置应用”旁边  ，选择“删除”  。 有关内置应用的详细信息，请参阅[向 Microsoft Intune 添加内置应用](~/apps/apps-add-built-in.md)。
...
Intune Managed Browser 将停用。 使用 Microsoft Edge 获取受保护的 Intune 浏览器体验。 有关详细信息，请参阅“[采取措施：使用 Microsoft Edge 获得受保护的 Intune 浏览器体验](~/fundamentals/whats-new.md#take-action-use-microsoft-edge-for-your-protected-intune-browser-experience)”条目（下面的[通知](~/fundamentals/whats-new.md#notices)一节中）。
...
若要查看可配置的现有 Wi-Fi 设置，请参阅[在 Microsoft Intune 中为运行 Android Enterprise 和 Android 展台的设备添加 Wi-Fi 设置](../configuration/wi-fi-settings-android-enterprise.md)。
