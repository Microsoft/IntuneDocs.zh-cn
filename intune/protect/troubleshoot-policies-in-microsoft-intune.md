...
- [排查不应用于设备的 iOS 或 Android 策略问题](https://techcommunity.microsoft.com/t5/Intune-Customer-Success/Support-tip-Troubleshooting-iOS-or-Android-policies-not-applying/ba-p/280154)（打开另一个 Microsoft 站点）
...
- [排查适用于 Windows 10 的 CSP 自定义设置](https://support.microsoft.com/en-us/help/4055338/troubleshoot-csp-setting-windows-10-computer-intune)（打开另一个 Microsoft 站点）
...
可能需要先停用并重新注册其他平台（如 Android、iOS 和 Windows Phone 8.1），然后才能应用限制较少的策略。
