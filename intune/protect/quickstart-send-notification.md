...
以[全局管理员](../fundamentals/users-add.md#types-of-administrators)或 Intune [服务管理员身份](../fundamentals/users-add.md#types-of-administrators)登录 [Intune](https://aka.ms/intuneportal) 门户。 如果已创建 Intune 试用版订阅，则用于创建订阅的帐户就是全局管理员。
...
有关设置公司名称、公司联系人信息和公司徽标的详细信息，请参阅[公司信息和隐私声明](../apps/company-portal-app.md#company-information-and-privacy-statement)、[支持部门信息](../apps/company-portal-app.md#support-information)以及[公司标识品牌自定义](../apps/company-portal-app.md#company-identity-branding-customization)。 
