...
1.  转到  [Zimperium MTD 控制台](https://sso.zimperium.com/signon/aad/) 并使用你的凭据登录。
...
5.  将 Microsoft Intune 设置为 MDM 服务后，“Microsoft Intune 配置”窗口随即弹出。请为每个选项选择“添加 Azure Active Directory”：即添加“Zimperium zConsole”、“zIPS iOS 和 Android 应用”，以授权 Zimperium 通过 Azure AD 单一登录与 Intune 和 Azure AD 进行通信 ****  **** 。
