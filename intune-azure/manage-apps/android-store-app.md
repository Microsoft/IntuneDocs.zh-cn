---
title: "如何将 Android 应用商店应用添加到 Intune | Intune Azure 预览版 | Microsoft Docs"
description: "Intune Azure 预览版：了解如何将 Android 应用商店应用添加到 Intune。"
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-android-store-apps-to-intune"></a>如何将 Android 应用商店应用添加到 Intune
