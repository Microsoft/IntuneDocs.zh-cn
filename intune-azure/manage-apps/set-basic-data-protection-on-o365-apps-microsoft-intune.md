---
title: "在 Office 365 应用上设置基本数据管理 - Intune Azure 预览版 | Microsoft Docs"
...
详细了解[应用保护策略](https://docs.microsoft.com/intune-azure/manage-apps/what-is-app-protection-policy)。
