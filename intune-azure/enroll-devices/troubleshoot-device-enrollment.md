...
将看到一个 [iOS 注册错误](https://docs.microsoft.com/intune/enduser/you-see-errors-while-trying-to-enroll-your-device-in-intune-ios)列表，最终用户也可能会看到该列表。 该列表提供了有关最终用户可能看到的错误消息，以及解决错误需采取的步骤的信息。
