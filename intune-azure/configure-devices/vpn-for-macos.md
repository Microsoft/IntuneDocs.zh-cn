---
title: "适用于 macOS 设备的 Intune VPN 设置 | Intune Azure 预览版 | Microsoft Docs"
...
# <a name="vpn-settings-for-macos-devices-in-intune-azure-preview"></a>Intune Azure 预览版中适用于 macOS 设备的 VPN 设置
