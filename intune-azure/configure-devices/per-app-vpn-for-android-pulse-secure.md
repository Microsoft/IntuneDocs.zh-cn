...
# <a name="use-an-intune-custom-profile-to-create-a-per-app-vpn-profile-for-android-devices-in-intune-azure-preview"></a>在 Intune Azure 预览版中使用 Intune 自定义配置文件为 Android 设备创建每应用 VPN 配置文件
...
将策略部署到 Android 设备或用户组后，用户应启动 PulseSecure VPN。 然后，PulseSecure 将仅允许来自指定应用的通信使用打开的 VPN 连接。
