---
title: "为 PKCS 配置 Intune 证书基础结构 | Intune Azure 预览版 | Microsoft Docs"
...
---
# <a name="configure-your-intune-certificate-infrastructure-for-pkcs"></a>为 PKCS 配置 Intune 证书基础结构
