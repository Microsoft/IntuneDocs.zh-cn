---
title: "适用于 Windows Phone 8.1 设备的 Intune VPN 设置 | Intune Azure 预览版 | Microsoft Docs"
...
# <a name="vpn-settings-for-windows-phone-81-devices-in-intune-azure-preview"></a>Intune Azure 预览版中适用于 Windows Phone 8.1 设备的 VPN 设置
