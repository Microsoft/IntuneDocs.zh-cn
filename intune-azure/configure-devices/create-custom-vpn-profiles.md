---
title: "如何使用 Microsoft Intune 创建自定义 VPN 配置文件 | Microsoft Docs"
...
# <a name="how-to-create-custom-vpn-profiles-with-microsoft-intune"></a>如何使用 Microsoft Intune 创建自定义 VPN 配置文件
