...
### <a name="step-2-check-that-the-telecom-expense-management-feature-is-active-in-intune"></a>第 2 步：检查电信费用管理功能在 Intune 中是否处于活动状态
...
按照下列步骤，在 Intune 中为每个平台创建 Datalert 应用。 在这些步骤中将 iOS 用作示例。
...
若要设置这些项，请转到[适用于 Microsoft Intune 的 Datalert 设置页面](http://www.datalert.fr/microsoft-intune/intune-setup)(http://www.datalert.fr/microsoft-intune/intune-setup)，然后按照“设置”选项卡下设置向导中的步骤操作。
