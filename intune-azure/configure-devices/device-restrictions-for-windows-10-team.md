---
title: "适用于 Windows 10 协同版的 Intune 设备限制 |Intune Azure 预览版 | Microsoft Docs"
...
# <a name="windows-10-team-device-restriction-settings-in-intune-azure-preview"></a>Intune Azure 预览版中的 Windows 10 协同版设备限制设置
