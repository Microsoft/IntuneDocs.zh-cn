---
title: "适用于 Windows Phone 8.1 的 Intune 电子邮件设置 | Intune Azure 预览版 | Microsoft Docs"
...
# <a name="email-profile-settings-for-windows-phone-81-devices-in-intune-azure-preview"></a>Intune Azure 预览版中适用于 Windows Phone 8.1 设备的电子邮件配置文件设置
