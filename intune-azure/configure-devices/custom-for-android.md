---
title: "适用于 Android 设备的 Intune 自定义设置 | Intune Azure 预览版 | Microsoft Docs"
...
# <a name="custom-settings-for-android-devices-in-intune-azure-preview"></a>Intune Azure 预览版中适用于 Android 设备的自定义设置
