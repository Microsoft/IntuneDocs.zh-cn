---
title: "本地 EAS 的 Exchange Connector | Intune Azure 预览版 | Microsoft Docs"
...
|移动设备管理机构| [将移动设备管理机构设置为 Intune](https://docs.microsoft.com/en-us/intune/deploy-use/prerequisites-for-enrollment#step-2-set-mdm-authority)。|
