---
title: "解决 Skycure 在 iOS 上发现的威胁 | Microsoft Docs"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
![来自 Lookout for Work 的不合规消息](./media/ios-skycure-noncompliant-in-ssp.png)
...
如果已安装 Skycure 视为威胁的应用，Skycure 会在应用中通知你。
