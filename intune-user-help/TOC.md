...
## [更新我的密码](password-does-not-meet-it-administrator-requirements.md)
...
#### [注册 Windows 10 设备](enroll-your-w10-phone-or-w10-pc-windows.md)
...
### [从公司门户应用安装应用](install-apps-cpapp-windows.md) 
### [从公司门户应用远程锁定设备](remote-lock-your-device-cp-app.md)   
### [从公司门户应用中对设备进行重命名](rename-your-device-cpapp.md) 
