---
title: "在 Intune 中注册旧版 macOS 设备 | Microsoft Docs"
...
这些说明适用于使用 OS X Yosemite 10.10 及先前版本的 macOS 设备。 可在[此处](enroll-your-device-in-intune-macos-cp.md)查找有关在 macOS 较新版本上注册 macOS 设备的说明。
