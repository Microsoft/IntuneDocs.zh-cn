...
威胁在公司门户中显示为未解决的非符合性问题。 如果威胁被分类非常危险，公司将撤销对公司资源的访问权限。 只要设备上存在这些威胁，就可能无法：  
...
下面是组织可能已设置的特定于 Android 的 Mobile Threat Defense 服务。 选择应用以阅读有关其行为的详细信息。  
