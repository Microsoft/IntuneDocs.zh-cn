...
### <a name="windows"></a>Windows
  ...
  使用企业管理 + 安全性 (EMS) 的客户也可使用 Azure Active Directory (AAD) 来注册 Windows 10 设备 /intune-classic/deploy-use/set-up-windows-device-management-with-microsoft-intune#azure-active-directory-enrollment)。
...
有关设备和管理方法的完整列表，请参阅 [Intune 支持的设备](/intune-classic/get-started/what-to-know-before-you-start-microsoft-intune#intune-supported-devices)。
