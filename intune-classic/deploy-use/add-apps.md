...
|         <strong>Windows 应用包（.appx、.appxbundle）</strong>          |                                                                                                                                                                                                                                                                                                                                                                 若要部署应用，需要企业移动代码签名证书。 有关详细信息，请参阅[使用 Microsoft Intune 设置 Windows 设备管理](set-up-windows-device-management-with-microsoft-intune.md)。                                                                                                                                                                                                                                                                                                                                                                  |
