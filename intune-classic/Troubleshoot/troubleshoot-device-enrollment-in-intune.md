...
让用户按照[设备缺少必需的证书](/intune-user-help/your-device-is-missing-a-required-certificate-android#your-device-is-missing-a-certificate-required-by-your-it-administrator)中的说明操作。 如果用户按照此说明操作后仍出现此错误，请尝试解决方法 2。
