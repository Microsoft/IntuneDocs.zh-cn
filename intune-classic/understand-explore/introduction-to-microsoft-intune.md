...
* 应用程序条件访问（如果应用包含公司数据，则允许访问）/intune-classic/deploy-use/allow-policy-managed-apps-access-to-o365)
* [在同一个应用内将个人数据与公司数据隔离](/intune-classic/deploy-use/protect-app-data-using-mobile-app-management-policies-with-microsoft-intune)
* 应用程序保护策略（PIN、加密、另存为、剪贴板等）/intune-classic/deploy-use/protect-app-data-using-mobile-app-management-policies-with-microsoft-intune)
* [从移动应用擦除公司数据](/intune-classic/deploy-use/protect-app-data-using-mobile-app-management-policies-with-microsoft-intune)
...
* [向员工发放公司拥有的手机](common-ways-to-use-intune.md#issue-corporate-owned-phones-to-your-employees)
...
* [向任务工作者发放使用受限的共享平板电脑](common-ways-to-use-intune.md#issue-limited-use-shared-tablets-to-your-employees)

### <a name="next-steps"></a>后续步骤
* 了解一些 [Intune 的常见使用方式](common-ways-to-use-intune.md)。
* 通过 [Intune 的 30 天试用版](sign-up-for-30-day-trial-microsoft-intune.md)熟悉该产品。
* 深入了解 Intune 的[技术要求和功能](/intune-classic/get-started/what-to-know-before-you-start-microsoft-intune)。
