...
IT 管理员可使用 [Intune Managed Browser 应用](../deploy-use/manage-internet-access-using-managed-browser-policies.md)强制打开应用中的 Web 链接。 这可确保企业环境中显示的链接保持在 Intune 管理的应用的域中。
