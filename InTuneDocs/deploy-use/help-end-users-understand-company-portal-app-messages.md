---
title: "用户可能在 Android 设备上看到的公司门户消息 | Microsoft Docs"
...
将用户转到[在 Intune 中注册 Android 设备](/Intune/EndUser/enroll-your-device-in-intune-android)，使其获取详细信息。
...
### <a name="how-to-explain-this-to-your-users"></a>如何就此向用户解释
将用户转到[通过电子邮件向 IT 管理员发送日志](/Intune/EndUser/send-logs-to-your-it-admin-by-email-android)。 如果希望用户对比两种方法，还可将其转到[通过电缆向 IT 管理员发送日志](/Intune/EndUser/send-logs-to-your-it-admin-by-cable-android)。


### <a name="see-also"></a>另请参阅
[最终用户需了解的 Intune 使用情况](/intune/deploy-use/what-to-tell-your-end-users-about-using-microsoft-intune)
