...
[启用 Android for Work 注册](https://docs.microsoft.com/intune/deploy-use/set-up-android-for-work)

[为 Android for Work 部署应用](https://docs.microsoft.com/intune/deploy-use/android-for-work-apps)
