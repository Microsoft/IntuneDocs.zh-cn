...
-   请务必熟悉以下过程：
    ...
    -   [将应用添加到 Intune](https://docs.microsoft.com/intune/deploy-use/add-apps)。
...
[部署 Skycure 应用、Microsoft Authenticator 应用和 iOS 应用配置策略](https://docs.microsoft.com/intune/deploy-use/deploy-skycure-apps-microsoft-authenticator-app-and-ios-app-configuration-policy)
