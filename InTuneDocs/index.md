...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            ...
            <ul id="manage">
                <li>
                    <a href="#manage-featured">特别推荐文章</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">热门文章</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">推荐的文章</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune-azure/introduction/what-is-microsoft-intune">Azure 门户预览中的 Intune</a></h3>
                                            <p>Microsoft Intune 已迁移到 Azure 门户，了解新门户中提供的更改。 </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/plan-design/introduction">部署规划和设计</a></h3>
                                            <p>逐步完成开发部署计划、构建设计、载入 Intune 并执行生产推出等一系列过程。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/deploy-use/how-to-educate-your-end-users-about-microsoft-intune">如何使最终用户了解 Microsoft Intune</a></h3>
                                            <p>了解如何使最终用户接受 Intune 提供的安全访问权限。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">在 Microsoft Graph 中使用 Intune</a></h3>
                                            <p>使用 Microsoft Graph API 配置 Intune 控件和策略。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">150 多个许可证？利用 FastTrack 权益</a></h3>
                                            <p>与 Microsoft 专家一同访问、更正、启用并推进这些服务的使用。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/understand-explore/mam-faq">MAM 和应用保护常见问题解答</a></h3>
                                            <p>查找针对 Intune 移动应用管理和 Intune 应用保护的一些常见问题的解答。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/understand-explore/introduction-to-microsoft-intune">所有 Intune 文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">简介</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune 简介</h3>
                                            <p>了解 Intune 如何为移动设备和 Windows 电脑提供设备、应用和数据管理功能。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Microsoft Intune 中的移动设备管理</h3>
                                            <p>在 Intune 中评估移动设备管理的工作方式。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/understand-explore/introduction-to-microsoft-intune">所有介绍性文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/plan-design/introduction">所有计划部署文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">操作方法</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>创建条件访问策略</h3>
                                            <p>基于设备符合性配置 Exchange 本地环境的条件访问。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">所有操作方法文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">监视和故障排除</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>请参阅<a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">所有疑难解答文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune App SDK 概述</h3>
                                            <p>了解可用于启用 Intune 应用保护策略的应用的 SDK。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>本指南会指导你完成使用 Microsoft Intune 在应用中启用移动应用管理所需的主要步骤。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Intune App SDK for iOS 包括一个静态库、资源文件、API 标头、一个调试设置列表和一个配置器工具。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>准备适用于 MAM 的业务线应用</h3>
                                            <p>使用 Intune 应用包装工具或 Intune App SDK 启用应用以使用移动应用程序管理 (MAM) 策略。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>查找所有的文档？ 请参阅<a href="/intune/understand-explore/introduction-to-microsoft-intune">所有 Intune 文档</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>关注 Twitter 上的 Microsoft Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
