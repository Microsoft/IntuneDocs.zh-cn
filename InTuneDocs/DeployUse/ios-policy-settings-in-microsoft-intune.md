...
|**允许用户信任新的企业应用作者**|允许用户选择信任不是从应用商店下载的应用。|
...
|**不允许来自托管应用的 Airdrop**|停止托管应用通过 Airdrop 发送数据的功能 。|
...
|**允许 word 定义查找**|允许 iOS 功能，它允许突出显示某个字词并查找其定义。|
|**允许预测键盘**|允许使用预测键盘，它会建议用户可能想要使用的字词。|
