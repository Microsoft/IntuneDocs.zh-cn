...
# 在 Microsoft Intune 中利用软件更新使 Windows PC 保持最新版本
...
下表显示你可在策略中配置的值，还显示将在你未自定义策略的情况下使用的建议值。 你可以在“更新”  部分找到这些设置。
  ...
  |策略设置|详细信息|
    ...
    |**Windows 重新启动后开始安装错过的已计划更新和应用程序的延迟(分钟)** |指定在错过计划的更新后，在重启 Windows 多长时间后开始安装更新和应用程序（1-60 分钟）。<br /><br />建议的值： **5 分钟**|
...
1.  在 [Microsoft Intune 管理控制台](https://manage.microsoft.com/)中，选择“更新” &gt; “概述” &gt; “上载”。
...
|**批准**|批准所选更新，并允许你配置将更新部署到哪些组。 要了解更多信息，请参阅此主题中的[批准更新](keep-windows-pcs-up-to-date-with-software-updates-in-microsoft-intune.md#BKMK_Approve)过程。|
...
1.  在 [Microsoft Intune 管理控制台](https://manage.microsoft.com/)中，单击“更新” &gt; “概述” &gt; “要批准的新更新”。

    在“更新”工作区中，单击“概述” &gt; “要批准的新更新”。

    > “要批准的新更新”  链接在仅当有至少一个需要批准更新的托管计算机时才会显示在“更新状态”  区域中。

2.  选择更新，在页面底部查看更新属性，以确认要批准此更新，然后单击“批准”。 可通过在选择每一项时按住“CTRL”键来选择多个更新。

3.  在“选择组”页上，选择要为其部署更新的组，然后单击“添加”。 指定完组后，单击“下一步”
