...
title: 在 Microsoft Intune 中管理 Windows PC 软件的许可协议 | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
使用 Microsoft Intune，你可以为通过 Microsoft 批量许可协议购买的软件以及通过其他方法购买的 Microsoft 或非 Microsoft 软件添加和管理许可协议信息。 你还可以将此信息组织为多个逻辑组。

> [!IMPORTANT]
> 此功能仅为方便而提供，并不保证其准确性。 你不应依赖于该功能来确认 Microsoft 批量许可协议合规性。 Microsoft 将不会使用所收集的任何数据对或许违反或遵守你可能与我们签订的许可协议的情况进行调查。
> 
> 向 Intune 添加的许可证不会影响你的许可协议或使用软件的授权。  例如，从 Intune 中删除许可/协议编号对不会删除或废除你与 Microsoft 之间签订的许可协议。
...
## 添加 Microsoft 批量许可协议
Intune 批量许可协议提供通过 Microsoft 批量许可协议购买的软件的许可证信息。 可通过提供匹配的协议编号对将 Microsoft 批量许可协议添加到 Intune 中。 协议或授权编号必须与正确的许可证或注册编号匹配。 协议编号对是当你从[批量许可服务中心 (VLSC)](http://go.microsoft.com/fwlink/?LinkID=223842) 购买许可协议时获得的。.

1.  在 [Microsoft Intune 管理员控制台](https://account.manage.microsoft.com/admin/default.aspx)中，单击“许可证”。.

2.  在“添加协议”页的“选择协议类型”中选择“批量许可协议”。.

3.  在“添加协议详细信息”  部分中，选择以下选项之一：

    -   **上载包含协议详细信息的 CSV 文件** - 单击“浏览”，然后选择想要上载的 CSV 文件。
        ...
        -   此文件至少必须包含一个协议对，并且它包含的协议对数不能超过 5,000。
    ...
    -   **手动添加协议详细信息** - 提供以下信息，然后在“授权/协议编号”和“许可证/注册/客户编号”框中键入协议编号对。 键入这两个编号后，单击“添加对”  图标保存编号，然后根据需要添加新对。
...
4.  在“选择许可证组”  区域中，执行以下操作之一：
    ...
    -   **将协议添加到未分配的协议组中** 如果不希望将新协议添加到许可证组，请选择此选项。

    -   **将协议添加到新许可证组中** - 提供新许可证组的名称。

    -   **将协议添加到现有的许可证组中** - 在“组名称”列表中，选择要向其中添加协议的许可证组。

5.  单击“确定”。.

将显示“所有协议”视图，并且 Intune 将连接到 Microsoft 批量许可服务中心以验证你提供的协议编号对是否正确。
...
> [!NOTE]
> 针对所有 Microsoft 批量许可证协议显示的**产品标题****不可用**。.
...
|-|-|
|任务|详细信息|
|创建许可证组|在“许可证”  工作区的“概述”  页上，单击“任务”  菜单中的“创建许可证组”  。 **注意：**你最多总共可以创建 500 个许可证组。|
|重命名许可证组|在“许可证”  工作区中，选择一个许可证组，然后从“任务”  菜单中单击“编辑许可证组”  。|
|删除许可证组|在“许可证”  工作区中，选择一个许可证组，然后从“任务”  菜单中单击“删除许可证组”  。 **提示：**删除的组中包含的所有许可证都会移动到“未分配的协议”许可证组中。|
|删除许可协议|在“许可证”工作区中选择一个协议，然后单击“删除”. **提示：**删除批量许可协议后，要更新许可证信息，请在“许可证概述”页上或在特定许可证组的“常规”选项卡上单击“立即刷新”。|
