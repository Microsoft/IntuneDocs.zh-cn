...
description: "Intune 提供了一系列可在 Mac OS X 设备上进行配置的内置常规设置。 此外，还可使用 Apple 配置器工具创建 Intune 未提供的自定义设置。"
keywords: 
author: robstackmsft
manager: arob98
ms.date: 07/19/2016
...
Intune 提供了一系列可在 Mac OS X 设备上进行配置的内置常规设置。 此外，还可使用 Apple 配置器工具创建 Intune 未提供的自定义设置。
