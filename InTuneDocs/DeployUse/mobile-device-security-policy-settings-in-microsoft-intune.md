...
|**允许地理位置**<br /><br />此设置允许设备利用位置信息。|否|否|仅 Windows Phone 8.1|否|是（仅 Samsung KNOX）|
|**允许 NFC**<br /><br />此设置允许使用近场通信的操作。|否|否|仅 Windows Phone 8.1|否|是（仅 Samsung KNOX）|
|**允许蓝牙**|否|否|仅 Windows Phone 8.1|否|是（仅 Samsung KNOX）|
|**允许关闭电源**<br>如果禁用了此设置，则 Samsung KNOX 设备的“擦除设备前允许重复登录失败的次数”设置不起作用。|否|否|否|否|是（仅 Samsung KNOX）|
