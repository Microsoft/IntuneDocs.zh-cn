...
## **如何管理企业所拥有的专用设备？**
  ...
  > [!div class="button"]
[iOS DEP >](/intune/deploy-use/ios-device-enrollment-program-in-microsoft-intune)<br>[iOS 设置助理 >](/intune/deploy-use/ios-setup-assistant-enrollment-in-microsoft-intune)<br>[标记 IMEI >](/intune/deploy-use/specify-corporate-owned-devices-with-international-mobile-equipment-identity-imei-numbers)
