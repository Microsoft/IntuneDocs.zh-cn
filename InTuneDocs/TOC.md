# 了解和探索
## [Intune 简介](understand-explore/introduction-to-microsoft-intune.md)
...
## [设置 Intune](get-started/start-with-a-paid-subscription-to-microsoft-intune.md)
### 先决条件
...
# 规划和设计
## [部署规划、设计和实施](plan-design/introduction.md)
...
## [迁移](plan-design/intune-mdm-migration-guide.md)
### [阶段 1：针对 MDM 进行 Intune 准备](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [基本设置](plan-design/migration-phase1-basic-setup.md)
#### [配置设备和应用管理策略](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [配置应用保护策略](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [特殊迁移注意事项](plan-design/migration-phase1-special-migration-considerations.md)
### [阶段 2：迁移活动](plan-design/migration-phase2-migration-campaign.md)
#### [通信计划](plan-design/migration-phase2-communication-plan.md)
#### [推进采用](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [典型迁移周期](plan-design/migration-phase2-typical-migration-cycle.md)
...
### [设备生命周期](deploy-use/overview-of-device-lifecycle-in-microsoft-intune.md)
### [应用生命周期](deploy-use/overview-of-app-lifecycle-in-microsoft-intune.md)
...
### [管理电脑](deploy-use/manage-windows-pcs-with-microsoft-intune.md)
...
#### [面向 Windows 的应用保护策略](deploy-use/create-windows-information-protection-policy-with-intune.md)
#### [创建和部署面向 iOS 和 Android 的应用保护策略](deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune.md)
#### [创建和部署面向 Windows 10 的 WIP 应用保护策略](deploy-use/create-windows-information-protection-policy-with-intune.md)
...
### [准备适用于 MAM 的业务线应用](deploy-use/decide-how-to-prepare-apps-for-mobile-application-management-with-microsoft-intune.md)
#### [包装 iOS 应用](deploy-use/prepare-ios-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
#### [包装 Android 应用](deploy-use/prepare-android-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
...
### [最终用户将看到的公司门户消息](deploy-use/help-end-users-understand-company-portal-app-messages.md)
### [启用 MAM 的应用的 Android 最终用户体验](deploy-use/user-experience-for-mam-enabled-android-apps-with-microsoft-intune.md)
### [启用 MAM 的应用的 iOS 最终用户体验](deploy-use/user-experience-for-mam-enabled-ios-apps-with-microsoft-intune.md)
...
## [Microsoft Intune App SDK 入门](develop/intune-app-sdk-get-started.md)
## [Intune App SDK for iOS 开发人员指南](develop/intune-app-sdk-ios.md)
## [Intune App SDK for Android 开发人员指南](develop/intune-app-sdk-android.md)
## [Intune App SDK Cordova 插件](develop/intune-app-sdk-cordova.md)
## [Intune App SDK Xamarin 组件](develop/intune-app-sdk-xamarin.md)
